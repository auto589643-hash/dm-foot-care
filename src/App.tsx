...
function ExaminationDetail({ exam, diseaseRecords = [], loadPhoto, onClose }: { exam: Examination; diseaseRecords?: Disease[]; loadPhoto?: (examinationId: string, position: FootPosition) => Promise<string>; onClose: () => void }) {
  const [selectedPhoto, setSelectedPhoto] = useState<FootPosition | null>(null)
